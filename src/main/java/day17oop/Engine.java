...
public interface Engine {
     ...
     void start();  //All methods in an interface are "public" and "abstract" as default,
                    // that's why no need type "public" and "abstract" in methods creation.
     void stop();
    ...
    //2)All variables in an interface are "public", and "final", "static" as default that is why no need to type
    // "public", and "final", and "static" in method declaration

    public String ENGINE_NAME="Electrical Engine"; //public static final String enginName = "Electrical Engine"; has same meaning


    //public, static, and final its optional
