...
import java.io.IOException;
   ...
   /*
     ...
     6)"try block" cannot be used alone,
        "try block" can be used like "try block + multiple catch" or "try block + single catch"
        "try block + single catch + finally" or "try block + multiple catch + finally"
...
public class C01Exceptions {
   ...
   //Create methods to read text in a text file.
    ...
    public static void findAndReadTheFile(){
        ...
        try {
            ...
            FileInputStream fis = new FileInputStream("/Users/fatmakarmis/IdeaProjects/untitled/src/main/java/day20exceptions/MyFile.txt");
