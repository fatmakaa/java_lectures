package day18oop_static_keyword;
    ...
    1) Child   -    Parent
      ...
      Interface  -   Class     ==> This is impossible, cuz a class can't be the parent of an interface.



      2) What is the difference between "abstract class" and "interface"? (interview quest!!)
       i)Methods:Abstract Class can have "abstract", and "concrete" methods.
           ...
           ==>"static methods " are static that's why we can access them by using interface name
        ...
        iv)Usage:  When we need multiple parents contains the mandatory functionalities we use interfaces.
                   If a single parent is enough with mandatory and optional functionalities we use abstracts classes.


                  For example, you need many browsers to use in your application. Every browser has mandatory functionalities like get() method.
