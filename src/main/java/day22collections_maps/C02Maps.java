...
public class C02Maps {
    ...
    public static void main(String[] args) {
        ...
        Collection<Integer> stdAge = stdAges.values();
        System.out.println(stdAge);  //[76, 55, 43, 34, 23]


        int sumOfAge=0;


        for (Integer w : stdAge) {

            sumOfAge = sumOfAge +w;

        }

        System.out.println("Average age is: " + sumOfAge/stdAge.size());  //Average age is: 46.2
       ...
       Set<Map.Entry<String,Integer>> entries =stdAges.entrySet();
        ...
        int age1 = stdAges.get("Angelina");  //it will give me her age
