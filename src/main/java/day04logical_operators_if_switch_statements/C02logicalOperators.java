...
public class C02logicalOperators {
    ...
    public static void main(String[] args) {
        ...
        //Note1: Just a single "false" is enough to make the result false.(Perfectionist)
        //Note2: To get "true" from "&& Operation", all must be true
        ...
        // Note: If you use && in "And" operation, Java does not check the others after finding first false
        //       But if you wanna java to check all operations use "&"
        ...
        //"OR" Logical Operator:"||"
                //Note 4: Just a single "true" is enough to make result "true" in "||" operation. (Pollyanna)
